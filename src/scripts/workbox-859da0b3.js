...
define('./workbox-859da0b3.js', ['exports'], (function(t) {
    'use strict';
    try {
    ...
    class o {
        ...
        addCacheListener() {
            self.addEventListener('message', ((t) => {
                if (t.data && 'CACHE_URLS' === t.data.type) {
                    ...
                    const s = Promise.all(e.urlsToCache.map(((e) => {
                        'string' == typeof e && (e = [e]);
        ...
        handleRequest({ request: t, event: e }) {
            ...
            const { params: i, route: r } = this.findMatchingRoute({ event: e, request: t, sameOrigin: n, url: s });
            let o = r && r.handler;
            const a = t.method;
    ...
    const h = (t) => [c.prefix, t, c.suffix].filter(((t) => t && t.length > 0)).join('-');
    const u = (t) => t || h(c.precache);
    const l = (t) => t || h(c.runtime);
    ...
    class U {
        ...
        async fetch(t) {
            ...
            try {
                let t;
                t = await fetch(
                    n, 'navigate' === n.mode ? void 0 : this.l.fetchOptions);
        ...
        async cacheMatch(t) {
            ...
            const o = Object.assign(Object.assign({}, i), { cacheName: n });
        ...
        async cachePut(t, e) {
            ...
            const f = l ? await async function(t, e, s, n) {
                const i = R(e.url, s);
    ...
    class b extends class {
        ...
        handleAll(t) {
            ...
            const i = new U(this, { event: e, request: s, params: n });
    ...
    b.defaultPrecacheCacheabilityPlugin = { cacheWillUpdate: async({ response: t }) => !t || t.status >= 400 ? null : t }, b.copyRedirectedCacheableResponsesPlugin = { cacheWillUpdate: async({ response: t }) => t.redirected ? await g(t) : t };
    class L {
        constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
            this.k = new Map, this.j = new Map, this.T = new Map, this.l = new b({ cacheName: u(t), plugins: [...e, new p({ precacheController: this })], fallbackToNetwork: s }), this.install = this.install.bind(this), this.activate = this.activate.bind(this);
        }
        get strategy() {
            return this.l;
        }
        ...
        constructor(t, e) {
            super((({ request: s }) => {
                ...
                for (const t of
                    ...
                    function*(t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: s = 'index.html', cleanURLs: n = !0, urlManipulation: i } = {}) {
...
// # sourceMappingURL=workbox-859da0b3.js.map